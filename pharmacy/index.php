...
<script src="<?= htmlspecialchars(app_url('js/rx-crop-preview.js'), ENT_QUOTES, 'UTF-8') ?>?v=rx-crop-pan-1"></script>
<script src="js/orders.php?v=orders-rx-crop-pan-1"></script>
