...
<link rel="stylesheet" href="<?= htmlspecialchars(app_url('css/rx-crop-preview.css'), ENT_QUOTES, 'UTF-8') ?>?v=rx-crop-preview-2">
<link rel="stylesheet" href="css/orders.css?v=rx-crop-preview-2">
