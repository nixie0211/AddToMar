...
<link rel="stylesheet" href="css/orders.css?v=pharmacy-order-detail-1">
...
<script src="js/app.php?v=pharmacy-orders-badge-seen-1"></script>
...
<script src="js/orders.php?v=pharmacy-order-detail-1"></script>
