...
<link rel="stylesheet" href="<?= htmlspecialchars(app_url('css/rx-crop-preview.css'), ENT_QUOTES, 'UTF-8') ?>?v=rx-crop-preview-3">
<link rel="stylesheet" href="css/orders.css?v=rx-crop-preview-3">
...
<script src="js/orders.php?v=orders-rx-crop-preview-1"></script>
