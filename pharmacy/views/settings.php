              ...
              <div class="settings-panel">
                <div class="settings-section settings-section--flush">
                  <div class="form-grid settings-security-grid">
                    ...
                    <?php
                      $passwordEye = '<svg class="eye-show" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M2 12s3.5-7 10-7 10 7 10 7-3.5 7-10 7-10-7-10-7Z"/><circle cx="12" cy="12" r="3"/></svg><svg class="eye-hide" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-10-8-10-8a18.45 18.45 0 0 1 5.06-5.94"/><path d="M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 10 8 10 8a18.5 18.5 0 0 1-2.16 3.19"/><path d="M14.12 14.12a3 3 0 1 1-4.24-4.24"/><path d="M1 1l22 22"/></svg>';
                    ?>
                    <div class="field">
                      <label for="settings-current-password">Current password</label>
                      <div class="settings-password-wrap">
                        <input id="settings-current-password" type="password" placeholder="Current password" autocomplete="current-password" disabled>
                        <button type="button" class="settings-toggle-eye" aria-label="Show password"><?= $passwordEye ?></button>
                      </div>
                    </div>
                    <div class="field">
                      <label for="settings-new-password">New password</label>
                      <div class="settings-password-wrap">
                        <input id="settings-new-password" type="password" placeholder="New password" autocomplete="new-password" disabled>
                        <button type="button" class="settings-toggle-eye" aria-label="Show password"><?= $passwordEye ?></button>
                      </div>
                    </div>
                    <div class="field">
                      ...
                      <div class="settings-password-wrap">
                        <input id="settings-confirm-password" type="password" placeholder="Confirm new password" autocomplete="new-password" disabled>
                        <button type="button" class="settings-toggle-eye" aria-label="Show password"><?= $passwordEye ?></button>
                      </div>
                    </div>
                  </div>
