...
window.RESIDENCE_CONFIG = <?= json_encode([
  ...
  'paymongoCheckoutUrl' => app_url('ajax/paymongo-checkout.php'),
...
<script src="<?= htmlspecialchars(function_exists('app_url') ? app_url('js/rx-crop-preview.js') : '../js/rx-crop-preview.js', ENT_QUOTES, 'UTF-8') ?>?v=rx-crop-pan-1"></script>
<script src="<?= residence_asset('js/app.php') ?>?v=residence-rx-crop-pan-1"></script>
